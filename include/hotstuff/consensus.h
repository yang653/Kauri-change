...
bool rdy = false;
    ...
    std::vector<block_t> FindEquivProof(const block_t &Bparents,const block_t &Banc,std::unordered_map<ReplicaID,NewView> &Nvset);
...
public:
    bool finish_material;
    bool into_newview;
    std::vector<block_t> material_blk;
